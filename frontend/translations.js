...
const translations = {
  es: {
    ...
    project2_title: "E-commerce IA Agent",
    project2_desc: "E-commerce inteligente con IA Agent, recomendaciones personalizadas y chatbot integrado.",
    btn_demo: "Abrir Demo",
    btn_github: "GitHub",
  ...
  en: {
    ...
    project2_title: "E-commerce IA Agent",
    project2_desc: "Smart e-commerce with IA Agent, personalized recommendations and integrated chatbot.",
    btn_demo: "Open Demo",
    btn_github: "GitHub",
